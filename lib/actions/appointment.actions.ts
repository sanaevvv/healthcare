...
import { Appointment, AppointmentListType } from "@/types/appwrite.types";
...
export const getAppointment = async(appointmentId:string):Promise<CreateAppointmentParams|undefined>=> {
  try {
...
export const getRecentAppointmentList = async ():Promise<AppointmentListType|undefined> => {
  try {
